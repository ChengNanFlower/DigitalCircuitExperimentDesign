...
# 控制信号OE_N：配置到SW[1]开关上 (T18)
set_property PACKAGE_PIN T18 [get_ports {SW[1]}]

# 数据输入D[7:0]：配置到SW[9:2]开关上
...
set_property PACKAGE_PIN R10 [get_ports {SW[10]}]
set_property PACKAGE_PIN T11 [get_ports {SW[11]}]
set_property PACKAGE_PIN R11 [get_ports {SW[12]}]
set_property PACKAGE_PIN T8 [get_ports {SW[13]}]
set_property PACKAGE_PIN R8 [get_ports {SW[14]}]
set_property PACKAGE_PIN T9 [get_ports {SW[15]}]
